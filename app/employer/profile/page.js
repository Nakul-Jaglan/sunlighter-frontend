...
function EmployerProfilePage() {
  ...
  if (!user || user.user_type !== 'employer') {
    return (
      <Layout title="Employer Profile - SunLighter">
  ...
  return (
    <Layout title="Company Profile - SunLighter">
      <motion.div 
      ...
      >
        <motion.div className="mb-8" variants={itemVariants}>
          ...
          <p className="text-gray-600">
            Manage your company information and employer settings
          </p>
        </motion.div>
                ...
                <div className="flex items-center space-x-4">
                  <div className="w-16 h-16 bg-green-600 rounded-full flex items-center justify-center">
                    <span className="text-white text-2xl font-bold">
                      {user.company_name?.charAt(0)?.toUpperCase() || user.full_name?.charAt(0)?.toUpperCase() || 'C'}
                    </span>
                  </div>
                  <div>
                    ...
                    <div className="flex items-center space-x-4 mt-1">
                      ...
                      {user.employer_id && (
                        <span className="text-sm text-gray-600">ID: {user.employer_id}</span>
                      )}
                    </div>
                  </div>
                </div>
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between py-3 border-b border-gray-200">
                  <div>
                    ...
                    <p className="text-sm text-gray-600">Your employer account is currently active</p>
                  </div>
                ...
                <div className="flex items-center justify-between py-3 border-b border-gray-200">
                  <div>
                    ...
                    <p className="text-sm text-gray-600">
                      {user.is_verified ? 'Your company email is verified' : 'Please verify your company email address'}
                    </p>
                  </div>
                  <span className={`px-3 py-1 rounded-full text-sm font-medium ${
                ...
                <div className="flex items-center justify-between py-3 border-b border-gray-200">
                  <div>
                    <h4 className="font-medium text-gray-900">Company Handle</h4>
                    <p className="text-sm text-gray-600">
                      {user.company_handle ? `@${user.company_handle}` : 'Not set'}
                    </p>
                  </div>
                  <span className="text-sm text-gray-500">
                    {user.company_handle ? 'Assigned' : 'Pending'}
                  </span>
                </div>
            ...
            <Card className="p-6">
              ...
              <div className="grid md:grid-cols-2 gap-4">
                <Button variant="primary" className="p-4">
                  <a href="/employer/dashboard" className="text-white flex items-center justify-center">
